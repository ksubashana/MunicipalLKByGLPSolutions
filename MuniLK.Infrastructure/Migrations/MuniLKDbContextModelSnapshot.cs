...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.BuildingPlanApplication", b =>
                {
                    ...
                    b.Property<string>("CommissionerDecision")
                        .HasMaxLength(4000)
                    ...
                    b.Property<string>("EngineerReport")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.Property<Guid?>("PlanningCommitteeReviewId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("PlanningReport")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.HasIndex("SiteInspectionId")
                        .IsUnique()
                        .HasFilter("[SiteInspectionId] IS NOT NULL");

                    b.ToTable("buildingPlanApplications", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.BuildingPlanApplicationDocument", b =>
                {
                    ...
                    b.ToTable("buildingPlanApplicationDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.ClientConfiguration", b =>
                {
                    ...
                    b.ToTable("ClientConfigurations", (string)null);
                });

            modelBuilder.Entity("MuniLK.Domain.Entities.ContactEntities.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.EntityOptionSelection", b =>
                {
                    ...
                    b.HasIndex("EntityId", "EntityType", "ModuleId");

                    b.ToTable("EntityOptionSelections", (string)null);
                });

            modelBuilder.Entity("MuniLK.Domain.Entities.FeatureIdAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FeatureIdAudit", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.LicenseDocument", b =>
                {
                    ...
                    b.ToTable("licenseDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.PlanningCommitteeMeeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ChairpersonContactId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PlanningCommitteeMeetings", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.PlanningCommitteeMeetingApplication", b =>
                {
                    ...
                    b.ToTable("PlanningCommitteeMeetingApplications", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.PlanningCommitteeMeetingMember", b =>
                {
                    ...
                    b.ToTable("PlanningCommitteeMeetingMembers", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.PlanningCommitteeReview", b =>
                {
                    ...
                    b.Property<bool>("ApplicantRepresented")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ExternalAgenciesConsulted")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("FinalRecommendationDocumentPath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("InspectionReportsReviewed")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("RecordedByOfficer")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.ScheduleAppointments", b =>
                {
                    ...
                    b.Property<string>("AppTaskId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("AppointmentGroup")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("CommonGuid")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("RecurrenceExDate")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ScheduleAppointments", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.SiteInspection", b =>
                {
                    ...
                    b.Property<bool?>("AccessRoadWidthCondition")
                        .HasColumnType("bit");

                    b.Property<string>("AccessRoadWidthNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ApplicationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool?>("BoundaryVerification")
                        .HasColumnType("bit");

                    b.Property<string>("BoundaryVerificationNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClearancesRequired")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool?>("EncroachmentsReservations")
                        .HasColumnType("bit");

                    b.Property<string>("EncroachmentsReservationsNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("EnvironmentalConcerns")
                        .HasColumnType("bit");

                    b.Property<string>("EnvironmentalConcernsNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("ExistingStructures")
                        .HasColumnType("bit");

                    b.Property<string>("ExistingStructuresNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("FinalRecommendation")
                        .HasColumnType("int");

                    b.Property<bool?>("FrontSetback")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("MatchesSurveyPlan")
                        .HasColumnType("bit");

                    b.Property<string>("MatchesSurveyPlanNotes")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OfficersPresent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhotosPaths")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("RearSetback")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("SetbacksObserved")
                        .HasColumnType("bit");

                    b.Property<string>("SetbacksObservedNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("SideSetbacks")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("Topography")
                        .HasColumnType("bit");

                    b.Property<string>("TopographyNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("ZoningCompatible")
                        .HasColumnType("bit");

                    b.Property<string>("ZoningCompatibleNotes")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("SiteInspections", (string)null);
                });
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.BuildingPlanApplication", b =>
                {
                    b.HasOne("MuniLK.Domain.Entities.ContactEntities.Contact", "ApplicantContact")
                        .WithMany()
                        .HasForeignKey("ApplicantContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MuniLK.Domain.Entities.Assignment", "Assignment")
                        .WithOne()
                    ...
                    b.HasOne("MuniLK.Domain.Entities.SiteInspection", "SiteInspection")
                        .WithOne("Application")
                        .HasForeignKey("MuniLK.Domain.Entities.BuildingPlanApplication", "SiteInspectionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.Lookup", b =>
                {
                    ...
                    b.HasOne("MuniLK.Domain.Entities.Lookup", "ParentLookup")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.PropertyOwner", b =>
                {
                    b.HasOne("MuniLK.Domain.Entities.ContactEntities.Contact", "Contact")
            ...
            modelBuilder.Entity("MuniLK.Domain.Entities.ScheduleAppointments", b =>
                {
                    b.HasOne("MuniLK.Domain.Entities.User", "OwnerNav")
                        .WithMany()
